...
public class JRubyFileHandlerTest {
    ...
    public void testCall() throws Exception {
        ...
        String expected =
                new StringBuilder()
                        ...
                        .append("\r\n")
                        .append("Hello JRuby").toString();

        Pipe pipe = Pipe.open();
        Pipe.SourceChannel source = pipe.source();

        RequestHeaders headers = new RequestHeaders();
        headers.addHeader(HTTPHeader.LIONBEAST_REQUEST_URI, "/hello.rb");
        headers.addHeader(HTTPHeader.CONNECTION, HTTPHeaderValues.CLOSE.toString());

        JRubyFileHandler fileHandler = new JRubyFileHandler();
